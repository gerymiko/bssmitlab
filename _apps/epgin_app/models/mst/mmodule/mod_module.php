<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Mod_module extends CI_Model {
	    ...
	    private function _get_data(){
	    	$datax = array();
	    	$this->db->select('a.id_module, a.id_system, a.name as module_name, b.name as system_name, a.alias, a.description, a.status_active, b.description as desc_system, a.type');
	        $this->db->from('mst_system_module a');
	        $this->db->join('mst_system b', 'a.id_system = b.id_system AND b.status_active = 1 AND a.isdelete = 0', 'inner');
	        $i = 0;
