        ...
        public function table_user($site){
            ...
            foreach ($user as $field){
                if ($field->status_active == 1){
                    ...
                    $status = '<span class="text-red">Tidak Aktif</span>';
                }
                if ($field->login_time == null) {
                    $login_time = "<small>Belum melakukan login</small>";
                } else {
