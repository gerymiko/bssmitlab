	...
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/epgin/dist/js/bss.min.js"></script>
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/js/jquery.dataTables.min.js"></script>
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/js/dataTables.bootstrap.min.js"></script>
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/js/dataTables.responsive.min.js"></script>
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/js/buttons/dataTables.buttons.min.js"></script>
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/js/buttons/buttons.html5.min.js"></script>
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/js/jszip/jszip.min.js"></script>
