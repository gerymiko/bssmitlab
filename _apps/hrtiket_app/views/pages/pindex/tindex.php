...
<head>
   ...
   <meta name="description" content="web.binasaranasukses.com/hrtiket" />
   <meta name="keywords" content="web.binasaranasukses.com/hrtiket" />
   <meta name="author" content="PT BINA SARANA SUKSES" />
   ...
   <meta property="og:url" content="web.binasaranasukses.com/hrtiket">
...
<body id="body" class="hold-transition skin-yellow-light sidebar-mini">
   <div class="wrapper">
                        ...
                        <li class="user-footer">
                           <div class="pull-left">
                            ...
                            <div class="pull-right">
                              <a href="<?=site_url();?>cpanel/sysprofil/profil" class="btn bg-yellow btn-flat">Profil</a>
                           </div>
                        </li>
                     </ul>
                  </li>
