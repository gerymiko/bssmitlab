...
<head>
    ...
    <title>HRD TIKET | PT BINA SARANA SUKSES</title>
    <meta name="description" content="web.binasaranasukses.com/hr_tiket" />
    <meta name="keywords" content="web.binasaranasukses.com/hr_tiket" />
    <meta name="author" content="PT BINA SARANA SUKSES" />
    ...
    <meta property="og:url" content="web.binasaranasukses.com/hr_tiket">
...
<body class="hold-transition login-page bg-yellow">
    <div class="login-box">
        <div class="login-logo">
            <a href="#" class="white"><b class="red">BSS</b> <b>HRD</b> TIKET</a>
        </div>
        <div class="login-box-body">
            ...
            <form id="form-login" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control required" name="username" id="username" placeholder="Username" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="gerymiko">
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button type="button" class="btn bg-yellow btn-flat" id="btn-show-pass"><i id="btn-icon" class="fa fa-lock"></i></button>
                        </span>
                    </div>
                    <div id="error"></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button type="button" id="btn_login" class="btn bg-yellow btn-block btn-flat">MASUK</button>
                    </div>
                </div>
            </form>
            <div class="social-auth-links text-center">
              <p>- ATAU -</p>
              <a href="<?=site_url();?>syshome" class="btn btn-block bg-purple btn-flat">MENU APLIKASI</a>
            </div>
