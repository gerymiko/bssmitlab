...
<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/tiket/datatables/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/tiket/datatables/js/dataTables.fixedColumns.min.js"></script>
