      ...
      <div class="col-md-12">
         <div class="box box-default">
            ...
            <div class="box-header with-border">
               <h3 class="box-title">Data Akomodasi cuti POH - SITE</h3>
               <div class="box-tools pull-right">
                  <button type="button" class="btn btn-sm bg-purple"><i class="fa fa-plus"></i></button>
               </div>
            </div>
            <div class="box-body">
               <table id="table_akomodasi_cuti" class="table table-striped table-hover" width="100%">
...
<script type="text/javascript">
   $(function (){
      $("#li-bPoHCti").addClass("bg-purple");
      $("#href-bPoHCti").addClass("white");

      var table = $('#table_akomodasi_cuti').DataTable({
         processing: true,
         serverSide: true,
         scrollX: true,
         scrollCollapse: true,
         ...
         order: [],
         ajax: {
            url  : '<?=site_url()?>cpoh/syspoh/table_akomodasi_cuti',
            type : 'POST',
            error: function(data) {
