<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Mod_option extends CI_Model {
		...
		var $col_order_option  = array(null, 'a.req_date', 'a.nodoc', 'a.flight_date', 'a.flight_from', 'a.flight_to', 'a.depart_time', 'a.arrival_time', 'b.airline_name', 'a.sts');
		var $col_search_option = array('a.req_date', 'a.nodoc'); 
		var $order_option      = array('a.req_date' => 'DESC');

		var $col_order_doption  = array(null, 'a.nodoc', 'a.depart_time', 'a.arrival_time', 'a.price_opsi', 'a.sts_opsi', 'b.airline_name', 'c.nik', 'd.Nama', 'c.tipe');
	    ...
	    private function _get_detail_ticket_option($nodoc){
	    	...
	    	$this->db->select('a.id, a.nodoc, a.depart_time, a.arrival_time, a.price_opsi, a.sts_opsi, b.airline_name, c.nik, d.Nama, c.tipe');
	        ...
	        if(isset($_POST['order'])){
				$this->db->order_by($this->col_order_doption[$_POST['order']['0']['column']], $_POST['order']['0']['dir']);
	    ...
	    function save_ticket_selected($id, $data){
	    	$dataid = array('id' => $this->pregRepn($id));
			$this->db->where($dataid);
	    	$this->db->update('TOpsi_tiket', $data);
