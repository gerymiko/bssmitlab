	...
	<link rel="stylesheet" type="text/css" href="<?=siteURL()?>bssmitlab/_assets/epgin/dist/css/bss.min.css"/>
	<link rel="stylesheet" type="text/css" href="<?=siteURL()?>bssmitlab/_assets/epgin/dist/css/skins/skin-blue-light.min.css"/>
	<link rel="stylesheet" type="text/css" href="<?=siteURL()?>bssmitlab/_assets/epgin/dist/css/custom.css"/>
	<link rel="stylesheet" type="text/css" href="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/css/dataTables.bootstrap.min.css"/>
	<link rel="stylesheet" type="text/css" href="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/css/responsive.dataTables.min.css"/>
	<link rel="stylesheet" type="text/css" href="<?=siteURL()?>bssmitlab/_assets/epgin/bs-datatables/css/buttons.dataTables.min.css"/>
