<section class="content-header">
   <h4>Master Parameter Raport Loading <b class="text-blue"><?=$this->session->userdata('site')?></b></h4>
</section>
<section class="content">
   	<div class="nav-tabs-custom">
      	<ul class="nav nav-tabs">
         	<li class="active"><a href="#tab_1" data-toggle="tab">Raport Loading HDR</a></li>
         	<li><a href="#tab_2" data-toggle="tab">Raport Loading DTL</a></li>
        </ul>
        <div class="tab-content">
        	<div class="tab-pane active" id="tab_1">
        			...
        			<div class="box-tools pull-right">
        				<?php
	        				if ($accessRights->id_level == 1) {
	        					echo '<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-add-raport-loading-hdr"><i class="fas fa-plus"></i></button>';
	        				} else {
        		...
        		<div class="box-body">
        			<table id="table_raport_loading_hdr" class="table table-border table-striped table-hover" width="100%">
        				<thead>
        					<tr>
        						<th>#</th>
        	...
        	<div class="tab-pane" id="tab_2">
        		<div class="box-header">
        			...
        			<div class="box-tools pull-right">
        				<?php
	        				if ($accessRights->id_level == 1) {
	        					echo '<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-add-raport-loading-dtl"><i class="fas fa-plus"></i></button>';
	        				} else {
	        					echo '<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>';
	        				}
        				?>
        		...
        		<div class="box-body">
        			<table id="table_raport_loading_dtl" class="table table-border table-striped table-hover" width="100%">
        				<thead>
        					<tr>
        						<th>#</th>
        						<th class="text-center">Parameter</th>
...
<div class="modal" id="modal-add-raport-loading-hdr">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header no-border">
                ...
                <h4 class="modal-title">Tambah Data Raport loading HDR</h4>
            </div>
            <form id="form-add-raport-loading-hdr" action="#" method="post">
                ...
                <div class="modal-footer no-border">
                    <button type="button" id="btn_add_raport_loading_hdr" class="btn btn-primary">Simpan</button>
                </div>
            </form>
        </div>
    </div>
</div>
<div class="modal" id="modal-edit-raport-loading-hdr">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header no-border">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title">Ubah Data Raport loading HDR</h4>
            </div>
            <form id="form-edit-raport-loading-hdr" action="#" method="post">
                ...
                <div class="modal-footer no-border">
                    <button type="button" id="btn_edit_raport_loading_hdr" class="btn btn-primary">Simpan</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal" id="modal-add-raport-loading-dtl">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header no-border">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title">Tambah Data Raport Loading DTL</h4>
            </div>
            <form id="form-add-raport-loading-dtl" action="#" method="post">
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="dynamic_value" class="form-control _CalPhaNum required" maxlength="50">
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer no-border">
                    <button type="button" id="btn_add_raport_loading_dtl" class="btn btn-primary">Simpan</button>
                </div>
            </form>
        </div>
    </div>
</div>
<div class="modal" id="modal-edit-raport-loading-dtl">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header no-border">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title">Ubah Data Raport Loading DTL</h4>
            </div>
            <form id="form-edit-raport-loading-dtl" action="#" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">Dynamic Value</label>
                        <input type="text" name="dynamic_value" id="dynamic_value" class="form-control _CalPhaNum required" maxlength="50">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Nilai</label>
                ...
                <div class="modal-footer no-border">
                    <button type="button" id="btn_edit_raport_loading_dtl" class="btn btn-primary">Simpan</button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function (){
      	$('#master-treeview, #link_master_raport_loading').addClass('active');
        ...
        $('.modal').on('hidden.bs.modal', function (e) {
      	...
      	var table1 = $('#table_raport_loading_hdr').DataTable({
			"processing": true,
			"serverSide": true,
			"responsive": true,
			"order": [],
			"ajax": {
				"url": '<?=site_url('raport_loading/t_master_raport_loading_hdr/').$accessRights->site?>',
				"type": 'POST',
        ...
        $('#modal-edit-raport-loading-hdr').on('show.bs.modal', function (event) {
        ...
        $("#btn_add_raport_loading_hdr").click(function () {
         $("#loading").removeClass("hidden");
         var formdata = $("#form-add-raport-loading-hdr").serialize();
         if($("#form-add-raport-loading-hdr").valid() == false){
            $("#loading").addClass("hidden");
            return false;
         } else {
            $.post("<?=site_url('sadd/raport_loading_hdr/').$accessRights->site?>",
            formdata,
            function(data) {
               if(data == "Success"){
                  table1.ajax.reload();
                  $("#loading").addClass("hidden");
                  $('#modal-add-raport-loading-hdr').modal('hide');
                  ...
                  $('#modal-add-raport-loading-hdr').modal('toggle');
                  $("#loading").addClass("hidden");
        ...
        $("#btn_edit_raport_loading_hdr").click(function () {
         $("#loading").removeClass("hidden");
         var formdata = $("#form-edit-raport-loading-hdr").serialize();
         if($("#form-edit-raport-loading-hdr").valid() == false){
            $("#loading").addClass("hidden");
            return false;
         } else {
            $.post("<?=site_url('sedd/raport_loading_hdr/').$accessRights->site?>",
            formdata,
            function(data) {
               if(data == "Success"){
                  table1.ajax.reload();
                  $("#loading").addClass("hidden");
                  $('#modal-edit-raport-loading-hdr').modal('hide');
                  swal({title: "",html: '<i class="fas fa-check-circle f40 margin10 text-green"></i><br>Data saved successfully.',type: "",confirmButtonText: 'Okay',});
               } else if(data == "unauthority"){
                  $('#modal-edit-raport-loading-hdr').modal('toggle');
                  $("#loading").addClass("hidden");
                  swal({title: "",html: '<i class="fas fa-exclamation-circle f40 margin10 text-red"></i><br>You do not have access.',type: "",confirmButtonText: 'Okay',});
               } else {
                  $("#loading").addClass("hidden");
		...
		var groupColumn = 1;
		var table2 = $('#table_raport_loading_dtl').DataTable({
		 	"processing": true,
		 	"serverSide": true,
		 	"responsive": true,
		 	"order": [],
		 	"ajax": {
		    	"url": '<?=site_url('raport_loading/t_master_raport_loading_dtl/').$accessRights->site?>',
		    	"type": 'POST',
        ...
        $('#modal-edit-raport-loading-dtl').on('show.bs.modal', function (event) {
            if (event.namespace == 'bs.modal') {
                var button = $(event.relatedTarget)
        ...
        $("#btn_add_raport_loading_dtl").click(function () {
         $("#loading").removeClass("hidden");
         var formdata = $("#form-add-raport-loading-dtl").serialize();
         if($("#form-add-raport-loading-dtl").valid() == false){
            $("#loading").addClass("hidden");
            return false;
         } else {
            $.post("<?=site_url('sadd/raport_loading_dtl/').$accessRights->site?>",
            formdata,
            function(data) {
               if(data == "Success"){
                  table2.ajax.reload();
                  $("#loading").addClass("hidden");
                  $('#modal-add-raport-loading-dtl').modal('hide');
                  swal({title: "",html: '<i class="fas fa-check-circle f40 margin10 text-green"></i><br>Data saved successfully.',type: "",confirmButtonText: 'Okay',});
               } else if(data == "unauthority"){
                  $('#modal-add-raport-loading-dtl').modal('toggle');
                  $("#loading").addClass("hidden");
                  swal({title: "",html: '<i class="fas fa-exclamation-circle f40 margin10 text-red"></i><br>You do not have access.',type: "",confirmButtonText: 'Okay',});
               } else {
                  $("#loading").addClass("hidden");
        ...
        $("#btn_edit_raport_loading_dtl").click(function () {
         $("#loading").removeClass("hidden");
         var formdata = $("#form-edit-raport-loading-dtl").serialize();
         if($("#form-edit-raport-loading-dtl").valid() == false){
            $("#loading").addClass("hidden");
            return false;
         } else {
            $.post("<?=site_url('sedd/raport_loading_dtl/').$accessRights->site?>",
            formdata,
            function(data) {
               if(data == "Success"){
                  table2.ajax.reload();
                  $("#loading").addClass("hidden");
                  $('#modal-edit-raport-loading-dtl').modal('hide');
                  swal({title: "",html: '<i class="fas fa-check-circle f40 margin10 text-green"></i><br>Data saved successfully.',type: "",confirmButtonText: 'Okay',});
               } else if(data == "unauthority"){
                  $('#modal-edit-raport-loading-dtl').modal('toggle');
                  $("#loading").addClass("hidden");
                  swal({title: "",html: '<i class="fas fa-exclamation-circle f40 margin10 text-red"></i><br>You do not have access.',type: "",confirmButtonText: 'Okay',});
               } else {
                  $("#loading").addClass("hidden");
