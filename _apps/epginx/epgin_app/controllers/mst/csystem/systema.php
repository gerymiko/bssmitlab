    ...
    class Systema extends CI_Controller{
        ...
        function __construct(){
            ...
            if ($this->session->userdata('idu') == null && $this->session->userdata('nik') == null){
                ...
                $this->accessRights = $this->mod_global->get_access_rights($this->session->userdata('idu'), $this->uri->segment(3), $this->pregReps('master_sistem'));
            ...
            $this->load->model(['mst/msystem/mod_system']);
        }
        ...
        public function master_sistem($site){
            $data = array(
                'header'  => 'pages/ext/header',
                'footer'  => 'pages/ext/footer',
                'menu'    => $this->mod_global->menu($this->accessRights->id_user, $site),
                'content' => 'pages/mst/psystem/vmsystem',
