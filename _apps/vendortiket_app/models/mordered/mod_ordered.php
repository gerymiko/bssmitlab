<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Mod_ordered extends CI_Model {
		...
		var $col_order_ordered  = array(null, 'a.nik', 'a.flight_date', 'a.depart_time', 'a.arrival_time', 'a.flight_from', 'a.flight_to', 'a.price', 'a.req_date', 'a.nodoc', 'b.airline_name', 'd.final_price');
		var $col_search_ordered = array('a.req_date', 'a.nodoc'); 
	    ...
	    private function _get_ticket_ordered(){
	    	...
	    	$this->db->select('a.nik, a.airline_code, a.flight_date, a.depart_time, a.arrival_time, a.flight_from, a.flight_to, a.price, a.sts, a.req_date, a.nodoc, a.req_update, b.airline_name, a.tipe, d.final_price, d.depart_time as jam_pergi, d.arrival_time as jam_tiba, d.desc, d.file, d.final_airline, c.Nama');
	        ...
	        if(isset($_POST['order'])){
				$this->db->order_by($this->col_order_ordered[$_POST['order']['0']['column']], $_POST['order']['0']['dir']);
