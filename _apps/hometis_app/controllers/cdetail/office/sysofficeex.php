...
class Sysofficeex extends CI_Controller {
   ...
   function export($site){
      ...
      $trend_data = $this->mod_detail_office->fetch_data_trend($site, $sn, $dateStart, $dateEnd);
      $obj = new PHPExcel();
      ...
      $objWorkSheet1->setTitle('Detail Genset Office');
      // EXPORT
      $filename = 'Detail_Genset_Office_'.date("Ymd_His").'.xls';
