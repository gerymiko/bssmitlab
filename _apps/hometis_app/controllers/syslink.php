<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Syslink extends CI_Controller {
        ...
        public function logo(){
            $lokasi   = dirname("D:\\").'/images/hometis';
            $filename = $lokasi.'/'.urldecode('hometislogo-min.png');
        ...
        public function logo_small(){
            $lokasi   = dirname("D:\\").'/images/hometis/';
            $filename = $lokasi.'/'.urldecode('logosimple-min.png');
            header('Content-Description: File Transfer');
            header('Content-Type: application/file');
            header('Content-Disposition: attachment; filename='.basename($filename));
            header('Content-Transfer-Encoding: binary');
        ...
        public function wall(){
            $lokasi   = dirname("D:\\").'/images/hometis/';
            $filename = $lokasi.'/'.urldecode('wall-min.jpg');
            header('Content-Description: File Transfer');
            header('Content-Type: application/file');
            header('Content-Disposition: attachment; filename='.basename($filename));
            header('Content-Transfer-Encoding: binary');
        ...
        public function logo_dashboard(){
            $lokasi   = dirname("D:\\").'/images/hometis/';
            $filename = $lokasi.'/'.urldecode('hometissm-min.png');
            header('Content-Description: File Transfer');
            header('Content-Type: application/file');
            header('Content-Disposition: attachment; filename='.basename($filename));
            header('Content-Transfer-Encoding: binary');
        ...
        public function reset(){
            $lokasi   = dirname("D:\\").'/images/hometis/';
            $filename = $lokasi.'/'.urldecode('reset_forgot_password.png');
            header('Content-Description: File Transfer');
            header('Content-Type: application/file');
            header('Content-Disposition: attachment; filename='.basename($filename));
            header('Content-Transfer-Encoding: binary');
