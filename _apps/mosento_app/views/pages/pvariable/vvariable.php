<section class="content-header">
   <h4>Master Variable <small>Configuration of the standard values of each mosento technical parameter</small></h4>
</section>
<section class="content">
	<div class="box">
			...
			<div class="box-tools pull-right">
				<?php
					if ($accessRights->id_level == 1) {
						echo '<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-add-variable">Add Variable</button>';
					} else {
		...
		<div class="box-body">
			<table id="table_variable" class="table table-border table-striped table-hover" width="100%">
				<thead class="bg-gray">
					<tr>
						<th>#</th>
...
<script type="text/javascript">
   $(document).ready(function (){
    	...
    	$('#link_master_variable').addClass('active');
   	...
   	var table = $('#table_variable').DataTable({
         ...
         "order": [],
         "ajax": {
             "url": '<?=site_url()?>variable/t_variable/<?=$accessRights->site?>',
             "type": 'POST',
