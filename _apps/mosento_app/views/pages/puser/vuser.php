<section class="content-header">
   <h4>Master User &amp; Privilege Access</h4>
</section>
			...
			<div class="box-tools pull-right">
				<?php
					if ($accessRights->id_level == 1 || $accessRights->id_level == 2) {
						echo '<button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-add-user">Add User</button> <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-add-moduser">Add Access</button>';
					} else {
		...
		<div class="modal-content">
			...
			<form id="form-module" method="post" action="#">
				...
				<div class="modal-footer no-border">
					...
					<button type="button" id="btn_module" class="btn btn-primary">Save</button>
				</div>
			</form>
		</div>
	</div>
			...
			<form id="form-edit-user" method="post" action="#">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						Note :
						<ol>
							<li>E-mail and mobile number are <b>important</b> to reset password when the user forgets they password.</li>
...
<script type="text/javascript">
	$(document).ready(function (){
		...
		$('#link_master_user').addClass('active');
