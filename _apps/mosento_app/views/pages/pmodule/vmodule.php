			...
			<div class="box-tools pull-right">
				<?php
					if ($accessRights->id_level == 1) {
						echo '<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-add-module">Add Module</button>';
					} else {
...
<script type="text/javascript">
    $(document).ready(function (){
    	...
    	$('#link_master_module').addClass('active');
      ...
      var groupColumn = 1;
   	var table = $('#table_module').DataTable({
         ...
         "order": [],
         "ajax": {
            "url": '<?=site_url()?>module/t_module/<?=$accessRights->site?>',
            "type": 'POST',
