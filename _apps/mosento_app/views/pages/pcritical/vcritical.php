<section class="content-header">
   <h4>Critical Report <b class="text-red"><?=$accessRights->site?></b></h4>
</section>
<section class="content">
	<div class="row">
		...
		<div class="col-md-3">
			<div class="info-box">
               	...
               	<div class="info-box-content bg-white">
                  	<span class="info-box-text"><b class="text-red">Critical</b> Report<br> this Month</span>
               	</div>
            </div>
		</div>
		<div class="col-md-3">
			<div class="info-box">
               	...
               	<div class="info-box-content bg-white">
                  	<span class="info-box-text"><b class="text-red">Critical</b> Report<br> this Year</span>
               	</div>
            </div>
		</div>
	</div>
	<div class="box">
		<div class="box-body">
			<table id="table_critical" class="table table-border table-striped table-hover" width="100%">
				<thead class="bg-gray">
					<tr>
						<th>#</th>
						<th>Unit</th>
...
<script type="text/javascript">
	$(document).ready(function (){
		...
		var table = $('#table_critical').DataTable({
			"processing": true,
			"serverSide": true,
			"responsive": true,
			"order": [],
			"ajax": {
				"url"  : '<?=site_url('report/t_critical/').$accessRights->site?>',
				"type" : 'POST',
