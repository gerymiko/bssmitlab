...
<head>
	<meta charset="utf-8" />
	<title>Registration for the MOSENTO website account PT BINA SARANA SUKSES</title>
														            ...
														            <td style="color:#333333;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:18px" align="left">
														                ...
														                <table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%" align="left">
														                    <tbody>
														                        ...
														                        <tr>
														                            <td>Our system receives notifications for changes to your account password on the website <a href="http://bit.ly/2BsSMos" target="_blank" rel="noopener noreferrer"><b>MOSENTO</b></a>.</td>
														                        </tr>
														                        <tr>
														                            <td>
														                                <table width="1" border="0" cellspacing="0" cellpadding="1" >
														            ...
														            <td style="color:#333333;font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:18px" align="left">
														                ...
														                <table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%" align="left">
														                    <tbody>
														                        ...
														                        <tr>
														                            <td>Date: <?=date("l").", ".date("d-m-Y", strtotime($updateDate))." ".date("g:i:s A", strtotime($updateDate));?></td>
														                        </tr>
														                        <tr>
														                            <td>Browser: <?=get_browser_name($_SERVER['HTTP_USER_AGENT']);?></td>
														                        </tr>
														                        <tr>
														                            <td>Last IP: <?=$lastIP;?></td>
														                        </tr>
														                        <tr>
														                            <td>Location: <?php
																						...
																						?> 
																						<?=$LocationArray['countryCode'].', '.$LocationArray['countryName'].' - '.$LocationArray['regionName']?></td>
														                        </tr>
														                        <tr>
														                        ...
														                        <tr>
														                            <td>For further information please contact our admin.</td>
														                        </tr>
														                        <tr>
														                            <td>
														                                <table width="1" border="0" cellspacing="0" cellpadding="1">
