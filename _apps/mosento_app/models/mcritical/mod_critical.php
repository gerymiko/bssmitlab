<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Mod_critical extends CI_Model {
	    ...
	    private function _get_critical($site){
	        ...
	        $this->db->like('a.ket', 'CRITICAL', 'both');
	        $this->db->where($datax);
	        $i = 0;
	    ...
	    function get_critical($length, $start, $site){
	        $this->_get_critical($site);
	    ...
	    function count_critical_month($site){
	    ...
	    function count_critical_year($site){
