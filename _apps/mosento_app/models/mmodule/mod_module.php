<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Mod_module extends CI_Model {
	    ...
	    private function _get_data(){
	    	$datax = array();
	    	$this->db->select('a.id_module, a.id_system, a.name as module_name, a.alias, a.description, a.status_active, b.description as desc_system');
	        $this->db->from('mos_system_module a');
	        $this->db->join('mos_system b', 'a.id_system = b.id_system AND a.status_active = 1 AND b.status_active = 1', 'inner');
	        $i = 0;
