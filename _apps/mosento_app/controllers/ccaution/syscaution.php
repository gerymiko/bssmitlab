<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Syscaution extends CI_Controller{
        ...
        public function today_caution($site){
        	$data = array(
                ...
                'today' => $this->mod_caution->count_caution_today($site),
                'week' => $this->mod_caution->count_caution_today($site),
                'month' => $this->mod_caution->count_caution_month($site),
                'year' => $this->mod_caution->count_caution_year($site),
                'css_script' => array(
        ...
        public function table_caution($site){
            $data   = array();
            $start  = $this->pregRepn($this->input->post('start'));
            $length = $this->pregRepn($this->input->post('length'));
            if ($start == null || $length == null || $start == "" || $length == ""){ show_404();exit(); }
            $caution_unit = $this->mod_caution->get_caution($length, $start, $site);
            ...
            $output = array(
                ...
                "recordsTotal"    => $this->mod_caution->count_all($site),
                "recordsFiltered" => $this->mod_caution->count_filtered($site),
                "data"            => $data,
            );
