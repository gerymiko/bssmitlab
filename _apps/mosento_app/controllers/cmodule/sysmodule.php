    ...
    class Sysmodule extends CI_Controller{
        ...
        function __construct(){
            ...
            if ($this->session->userdata('id_user') == null && $this->session->userdata('nik') == null){
                ...
                $this->accessRights = $this->mod_global->get_access_rights($this->session->userdata('id_user'), $this->uri->segment(3), $this->pregReps('master_module'));
            ...
            $this->load->model(['mmodule/mod_module']);
        }
        ...
        public function master_module($site){
            $data = array(
