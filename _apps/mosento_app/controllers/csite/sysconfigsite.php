<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Sysconfigsite extends CI_Controller{
        ...
        function __construct(){
            ...
            $this->load->model(['msite/mod_config_site']);
        }
        ...
        public function table_site($site){
            ...
            $site = $this->mod_config_site->get_data($length, $start);
            foreach ($site as $field){
            ...
            $output = array(
                ...
                "recordsTotal"    => $this->mod_config_site->count_all(),
                "recordsFiltered" => $this->mod_config_site->count_filtered(),
                "data"            => $data,
            );
