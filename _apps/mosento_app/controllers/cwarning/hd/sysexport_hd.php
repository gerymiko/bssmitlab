<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Sysexport_hd extends CI_Controller{
        ...
        function export($site){
            ...
            $trend_data = $this->mod_warning_hd->fetch_data_trend($sn, $dateStart, $dateEnd, $site);
            ...
            $warning_data = $this->mod_warning_hd->fetch_data_warning($sn, $dateStart, $dateEnd, $site);
            ...
            list($rowmaster1) = $this->mod_warning_hd->fetch_data_mastervar('engoiltemp');
            ...
            list($rowmaster2) = $this->mod_warning_hd->fetch_data_mastervar('fuelrate');
            foreach ($trend_data as $row){
            ...
            list($rowmaster3) = $this->mod_warning_hd->fetch_data_mastervar('tmoiltemp');
            foreach ($trend_data as $row){
            ...
            list($rowmaster4) = $this->mod_warning_hd->fetch_data_mastervar('cooltemp');
            foreach ($trend_data as $row){
            ...
            list($rowmaster5) = $this->mod_warning_hd->fetch_data_mastervar('blowbypress');
            foreach ($trend_data as $row){
            ...
            list($rowmaster6) = $this->mod_warning_hd->fetch_data_mastervar('blowbypress');
            foreach ($trend_data as $row){
            ...
            list($rowmaster7) = $this->mod_warning_hd->fetch_data_mastervar('travelspeed');
            foreach ($trend_data as $row){
            ...
            list($rowmaster8) = $this->mod_warning_hd->fetch_data_mastervar('enginespeed');
            foreach ($trend_data as $row){
            ...
            list($rowmaster9) = $this->mod_warning_hd->fetch_data_mastervar('frontbrake');
            foreach ($trend_data as $row){
            ...
            list($rowmaster10) = $this->mod_warning_hd->fetch_data_mastervar('rearbrake');
            foreach ($trend_data as $row){
            ...
            list($rowmaster11) = $this->mod_warning_hd->fetch_data_mastervar('oilpressmin');
            foreach ($trend_data as $row){
            ...
            list($rowmaster12) = $this->mod_warning_hd->fetch_data_mastervar('oilpressmax');
            foreach ($trend_data as $row){
