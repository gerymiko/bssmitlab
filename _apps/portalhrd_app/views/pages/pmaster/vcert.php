<section class="content-header" id="header-content">
	<h1>
		...
		<span class="label no-padding text-black">Master Sertifikat</span>
		<button type="button" data-tooltip="Tambah Sertifikat" data-tooltip-location="left" class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#modal-add-cert" data-backdrop="static" data-keyboard="false">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#recruit, #master-treeview, #master-cert").addClass("active");
		var table = $('#table_cond').DataTable({
			...
			"responsive": true,
			"ajax": {
				"url": '<?=site_url()?>web/table/master_cert',
				"type": 'POST',
				// data : function(data){
