<section class="content-header" id="header-content">
	<h1><span class="label no-padding text-black">Data Pelamar</span></h1>
</section>
	...
	<div class="box">
		<div class="box-header">
			...
			<div class="box-tools pull-right">
				<button type="button" data-tooltip="Tambah Pelamar" data-tooltip-location="left" class="btn btn-primary btn-sm" onclick="addApplicant();">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var table = $('#table_applicant').DataTable({
			...
			"ajax": {
				"url": '<?=site_url()?>form/table/applicant',
				"type": 'POST',
				"data" : function(data){
	...
	function btn_interview(id){
		$("#main-content, #header-content").addClass("hidden");
		$("#extra-content").removeClass("hidden");
		$("#extra-content").load("<?=site_url()?>form/start/interview/"+id, function(){
    		$(".select2").select2({ placeholder: "Pilih", allowClear: true });
    		localStorage.clear();
		});
	}
	function addApplicant(){
		$("#main-content, #header-content").addClass("hidden");
		$("#extra-content").removeClass("hidden");
		$("#extra-content").load("<?=site_url()?>form/add/applicant", function(){
    		$(".select2").select2({ placeholder: "Pilih", allowClear: true });
