         ...
         <div class="box-body">
            ...
            <div id="content-education" class="box box-custom">
               <div class="box-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           <label class="control-label">Nama Sekolah / Universitas / Perguruan Tinggi</label>
            ...
            <div id="content-experience" class="box box-custom">
               <div class="box-body">
                  ...
                  <button type="button" id="btn_add_exp_more" class="btn bg-purple btn-sm pull-right">+ Tambah</button>
               </div>
            </div>
            <div id="content-skill" class="box box-custom">
               <div class="box-body">
                  ...
                  <button type="button" id="btn_add_skill_more" class="btn bg-purple btn-sm pull-right">+ Tambah</button>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $("#btn_sv_applicant").click(function (){
         ...
         if($("#form_add_applicant").valid() == false){
            ...
            $.post("<?=base_url();?>form/sadd/applicant",
            formdata,
            function(data) {
               if(data == "Success"){
                  $("#loading").addClass("hidden");
                  swal({ title: "", html: '<i class="fas fa-check-circle f40 margin10 text-green"></i><br>Data berhasil disimpan.', type: "", confirmButtonText: 'Okay', allowOutsideClick: false
                     ...
                     $('#form_add_applicant')[0].reset(); $("input[type=checkbox]").prop("checked", ""); $('.select2').val(null).trigger('change'); $("#main-content, #header-content").removeClass("hidden"); $("#extra-content").addClass("hidden"); $('#table_applicant').DataTable().ajax.reload(); localStorage.clear(); });
               } else if(data == "Duplicate") {
                  $("#loading").addClass("hidden");
                  swal({ title: "", html: '<i class="fas fa-info-circle f40 margin10 text-orange"></i><br>Duplikat data pelamar. Pelamar sudah terdaftar.', type: "", confirmButtonText: 'Okay' });
               } else {
                  $("#loading").addClass("hidden");
   ...
   $(function() {
      ...
      $('#sim_A')
         ...
         if(localStorage.sim_A == "true"){ $('#content-sim-a').show();
         } else { $('#content-sim-a').hide(); localStorage.sim_A == "false"; }
      }).trigger('change');
      ...
      $('#sim_B1')
         ...
         if(localStorage.sim_B1 == "true"){ $('#content-sim-b1').show();
         } else { $('#content-sim-b1').hide(); localStorage.sim_B1 == "false"; }
      }).trigger('change');
      ...
      $('#sim_B2')
         ...
         if(localStorage.sim_B2 == "true"){ $('#content-sim-b2').show();
         } else { $('#content-sim-b2').hide(); localStorage.sim_B2 == "false"; }
      }).trigger('change');
      ...
      $('#sim_B1U')
         ...
         if(localStorage.sim_B1U == "true"){ $('#content-sim-b1u').show();
         } else { $('#content-sim-b1u').hide(); localStorage.sim_B1U == "false"; }
      }).trigger('change');
      ...
      $('#sim_B2U')
         ...
         if(localStorage.sim_B2U == "true"){ $('#content-sim-b2u').show();
         } else { $('#content-sim-b2u').hide(); localStorage.sim_B2U == "false"; }
      }).trigger('change');
   });
   ...
   function checkktp(){
      ...
      if( noktp == "" || noktp.length < 15){
         ...
         $.ajax({
            type: "POST",
            url: "<?=base_url();?>form/check/idnumber",
            cache: false,    
            ...
            success: function(response){ 
               try {
                  ...
                  swal({ title: "", html: '<i class="fas fa-times-circle f40 margin10 text-red"></i><br>Terjadi kesalahan.. Reload halaman ini dan pastikan koneksi internet Anda stabil.', type: "", confirmButtonText: 'Okay'});
               }  
            }
         });
      }
