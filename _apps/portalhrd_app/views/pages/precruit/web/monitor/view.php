<section class="content-header" id="header-content">
	<h1>
	   	<div class="btn-group">
			<button type="button" class="btn bg-blue btn-xs">3</button>
			<button type="button" class="btn bg-navy btn-xs">A</button>
	    </div>
	    <span class="label no-padding text-black">Monitoring Interview Web</span>
	</h1>
</section>
...
<section class="content" id="main-content">
	...
	<div class="box">
		<div class="box-body slider-table">
			<table id="table_monitor" class="table table-border table-striped table-hover" width="100%">
				<thead>
					<tr>
						<th>No</th>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var table = $('#table_monitor').DataTable({
			...
			"order": [],
			"ajax": {
				"url": '<?=site_url()?>web/table/monitoring',
				"type": 'POST',
				"data" : function(data){ data.people_fullname = $('#people_fullname').val();data.KodeJB = $('#KodeJB').val();data.domisili = $('#domisili').val();data.lowongan_status = $('#lowongan_status').val();},
