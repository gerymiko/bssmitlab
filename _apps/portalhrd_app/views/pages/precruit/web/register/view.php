<section class="content-header" id="header-content">
	<h1>
	    ...
	    <span class="label no-padding text-black">Daftar <b>Pengguna Web</b></span>
	</h1>
</section>
...
<section class="content" id="main-content">
	...
	<div class="box">
		<div class="box-body">
			<table id="table_register" class="table table-border table-striped table-hover" width="100%">
				<thead>
					<tr>
						<th>No</th>
						<th>Nama</th>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var table = $('#table_register').DataTable({
			...
			"order": [],
			"ajax": {
				"url": '<?=site_url()?>web/table/registered',
				"type": 'POST',
				"data" : function (data){data.people_fullname = $('#people_fullname').val();data.people_mobile = $('#people_mobile').val();data.people_email = $('#people_email').val();data.domisili = $('#domisili').val();},
