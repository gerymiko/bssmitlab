<section class="content-header" id="header-content">
	<h1>
	   	<div class="btn-group">
			...
			<button type="button" class="btn bg-navy btn-xs">G</button>
	    </div>
	    <span class="label no-padding text-black">Pelamar <b>Pra-Agreement</b></span>
	</h1>
</section>
...
<section class="content" id="main-content">
	...
	<div class="box box-primary desktop" id="content-filter">
		<div class="box-body">
			<form id="form-filter" action="#" class="form-horizontal">					
				...
				<div class="col-md-3">
	                <div class="form-group" style="margin-bottom: 0px;">
	                  	<input type="text" class="form-control _CnUmB" id="noktp" placeholder="No. KTP">
	                </div>
	            </div>
				<div class="col-md-3">
	                <div class="form-group" style="margin-bottom: 0px;">
	            ...
	            <div class="col-md-2">
	            	<div class="form-group" style="margin-bottom: 0px;">
	                  	<input type="text" class="form-control" id="date_range" placeholder="Tanggal Agreement">
	                </div>
	            </div>
	...
	<div class="box">
		<div class="box-body slider-content">
			<table id="table_pre_agreement" class="table table-border table-striped table-hover" width="100%">
				<thead>
					<tr>
						<th>No.</th>
						<th></th>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#recruit, #recruit-agreement, #recruit-treeview").addClass("active");
		...
		var table = $('#table_pre_agreement').DataTable({
			"processing": true,
			"serverSide": true,
			"responsive": true,
			"stateSave": true,
			...
			"order": [],
			"ajax": {
				"url": '<?=site_url()?>crecruit/web/agree/sysagreement/table_pre_agreement',
				"type": 'POST',
			...
			"columns": [
				...
				{ "data": "department", "className": "text-left", "orderable": false },
				{ "data": "position", "className": "text-left", "orderable": false },
				{ "data": "noktp", "className": "text-center", "orderable": false },
				{ "data": "date", "className": "text-center" },
				{ "data": "poh", "className": "text-center", "orderable": false },
	...
	function detailApplicant(id){
  	...
  	function proses_agreement(people_id, name){
	    swal({
	        title: "",
	        html: '<i class="fas fa-question-circle f40 margin10 text-orange"></i><br>Lanjutkan ke proses Agreement ERP? (<b>'+name+'</b>)',
	        type: "",
			...
			if (result.value) {
			    $.ajax({
					url: "<?=site_url()?>web/agreement/applicant/"+people_id,
					type: "post",
					data: { id:id },
  	...
  	function done_agreement(pelamar_id){
  		swal({ title: "", html: '<i class="fas fa-check-circle f40 margin10 text-green"></i><br>Pelamar ini telah terdaftar di tahap Agreement ERP.', type: "", confirmButtonText: 'Okay', timer: 3000 });
  	}
</script>