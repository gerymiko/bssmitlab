<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Sysqualify extends CI_Controller {
        ...
        function __construct() {
            ...
            $this->load->model(['mrecruit/web/election/mod_qualify']);
        }
        ...
        public function table_qualify(){
            ...
            foreach ($applicant as $field){
                ...
                $kspm    = ($tahap_kspm !== false) ? '<button class="btn btn-xs bg-blue"><i class="fas fa-envelope"></i> SMS</button>' : 'Tidak ada tahap KSPM & HRD';
                $teori   = ($tahap_teori !== false) ? '<button class="btn btn-xs bg-blue"><i class="fas fa-envelope"></i> SMS</button>' : 'Tidak ada tahap Tes Teori';
                $teknis  = ($tahap_teknis !== false) ? '<button class="btn btn-xs bg-blue"><i class="fas fa-envelope"></i> SMS</button>' : 'Tidak ada tahap Teknis';
                $praktek = ($tahap_praktek !== false) ? '<button class="btn btn-xs bg-blue"><i class="fas fa-envelope"></i> SMS</button>' : 'Tidak ada tahap Tes Praktek';
                $mcu     = ($tahap_mcu !== false) ? '<button class="btn btn-xs bg-blue"><i class="fas fa-envelope"></i> SMS</button>' : 'Tidak ada tahap MCU';
