...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        $('#btn-filter-warning').click(function(){
            ...
            // const filteredData = chart.filter(el => new Date(el.date).getTime() >= date_start_new.getTime() && new Date(el.date) <= date_end_new.getTime());
    ...
    //     var options = {
    //         chart: {
    //             renderTo: 'oil-temperature-chart',
    //             type: 'line',
    //         },
    //         title: {
    //             text: '',
    ...
    //         tooltip: {
    //             formatter: function(){
    //                 return '<b>Date : </b>'+this.x+ '<br><b>Temperature (°C)</b> : '+ this.y;
    //             }
    //         },
    //         legend: {
    //             align: 'left',
    ...
    //         series: []
    //     };
    //     var url =  "<?=site_url();?>chart_oil/unit/hd/<?=$this->my_encryption->encode($detail_hd->serialnumber)?>";
