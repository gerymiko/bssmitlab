...
<head>
   ...
   <title>HRD USER | PT BINA SARANA SUKSES</title>
   <meta name="description" content="web.binasaranasukses.com/hr_user" />
   <meta name="keywords" content="web.binasaranasukses.com/hr_user" />
   <meta name="author" content="PT BINA SARANA SUKSES" />
   ...
   <meta property="og:url" content="web.binasaranasukses.com/hr_user">
...
<body id="body" class="hold-transition skin-purple-light sidebar-mini">
   <div class="wrapper">
               ...
               <ul class="nav navbar-nav">
                  <li class="dropdown user user-menu">
                    ...
                    <li class="user-footer">
                      <div class="pull-left">
                       <a href="<?=site_url();?>cpanel/syspanel/logout" class="btn btn-warning btn-flat">Keluar</a>
                    </div>
                 </li>
              </ul>
            </div>
