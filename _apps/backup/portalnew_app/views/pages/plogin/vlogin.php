        ...
        <div class="login-box-body">
            ...
            <form id="form-login" action="#" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control required" name="nik" id="nik" placeholder="NIK" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="1007425">
                </div>
    ...
    <script>
        $(document).ready(function() {
            $("#btn_login").click(function () {
                ...
                $.ajax({
                    url: "<?=site_url();?>syslogin/check_login",
                    type: 'POST',
                    data: dataform,
                    dataType : 'JSON',
                    cache : false,
