<h4 style="margin-top: 0px;"><span class="label label-danger">MANAJEMEN DATA</span> Pengguna Terdaftar - <small>Data keseluruhan pendaftar melalui web karir PT. BSS</small></h4>
<hr>
<div class="panel panel-default" data-collapsed="0">
	<div class="panel-body">
        <form id="form-filter" class="form-horizontal">
        	<div class="row">
        		...
        		<div class="col-md-4">
        			<div class="container-fluid">
	        			<div class="form-group">
			                <input type="text" class="form-control input-sm" id="people_mobile" placeholder="No. HP">
			            </div>
			            <div class="form-group">
			                <input type="text" class="form-control input-sm" id="people_email" placeholder="Email">
			            </div>
			            <div class="form-group">
        		...
        		<div class="col-md-4">
        			<div class="tile-stats tile-primary">
						...
						<div class="num" data-start="0" data-end="<?=$totalpengguna;?>" data-postfix="" data-duration="1500" data-delay="600"><?=$totalpengguna;?></div>
						<p>Pengguna Web Karir</p>
					</div>
        		</div>
        	</div>
            <div class="form-group">
		...
		<div style="white-space: nowrap; height: auto; overflow-x: scroll; overflow-y: hidden; cursor: pointer;">
			<table class="table table-hover table-bordered" id="tablePengguna">
				<thead>
					<tr>
						<th class="text-center bold">No</th>
						<th class="text-center bold">ID</th>
						<th class="text-center bold">Nama Pengguna</th>
						<th class="text-center bold">L/P</th>
						<th class="text-center bold">Umur</th>
						<th class="text-center bold">Domisili</th>
						<th class="text-center bold">Email</th>
						<th class="text-center bold">No. Tlp</th>
						<th class="text-center bold">Melamar</th>
						<th class="text-center bold">Tgl Daftar</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
    	table = $('#tablePengguna').DataTable( {
			...
			"order": [],
			"ajax" : {
				"url"  : '<?php echo site_url('dtPengguna')?>',
				"type" : "POST",
		    	"data" : function ( data ) {
	        ...
	        "columnDefs": [
	            ...
	            },
	            {
	                ...
	                render : function(data ,type, row) {
			        	return '<a onClick="ajax_load(\'<?php echo site_url()?>detailPengguna/'+row[1]+'\')">'+data+'</a>'
			        }
	            },
				{
					"targets": [ 3 ],
