<h4 style="margin-top: 0px;"><span class="label label-warning" style="color: #FFF;">PELAMAR</span> Pelamar Tidak Kualifikasi - <small>Data pelamar yang tidak memenuhi syarat.</small></h4>
<hr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#tablePelamarQualify').DataTable( {
            ...
            "order": [],
            "ajax" : {
                "url"  : '<?php echo site_url('dtPelamarUnqualify')?>',
                "type" : "POST",
                "data" : function ( data ) {
