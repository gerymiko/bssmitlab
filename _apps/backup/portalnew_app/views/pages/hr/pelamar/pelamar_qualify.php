<h4 style="margin-top: 0px;"><span class="label label-warning" style="color: #FFF;">PELAMAR</span> Pelamar Kualifikasi - <small>Data pelamar yang memenuhi syarat.</small></h4>
<hr>
<div class="panel panel-default" data-collapsed="0">
    <div class="panel-body">
        <form id="form-filter" class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <button type="button" class="btn btn-info btn-primary" id="btn-filter">
                        Filter
        ...
        <div style="white-space: nowrap; height: auto; overflow-x: scroll; overflow-y: hidden; cursor: pointer;">
            <table id="tablePelamarQualify" class="table table-hover table-bordered nowrap" style="width:100%">
                <thead>
                    <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#tablePelamarQualify').DataTable( {
            "processing" : true,
            "serverSide" : true,
            "stateSave": true,
            "order": [],
            "ajax" : {
                "url"  : '<?php echo site_url('dtPelamarQualify')?>',
                "type" : "POST",
                "data" : function ( data ) {
