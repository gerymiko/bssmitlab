<h4 style="margin-top: 0px;"><span class="label label-success">MCU</span>  - <small>Data peserta Medical Check Up</small></h4>
<hr>
        ...
        <form id="form-filter" class="form-horizontal">
        	<div class="row">
        		...
        		<div class="col-md-4">
        			<div class="tile-stats tile-green">
						...
						<div class="num" data-start="0" data-end="<?=$totalMCU;?>" data-postfix="" data-duration="1500" data-delay="600"></div>
						<p>Total Pelamar</p>
					</div>
        		</div>
        	</div>
            <div class="form-group">
                <div class="col-sm-4">
					...
					<button type="button" class="btn btn-green btn-icon" id="btn-reset">
						Reset
			...
			<table class="table table-hover table-bordered" id="tableMedical">
				<thead>
					<tr>
						...
						<th class="text-center bold">No. Pasien</th>
						<th class="text-center bold">Tipe MCU</th>
						<th class="text-center bold">Status</th>
						<th class="text-center bold">Keterangan</th>
						<th class="text-center bold">Lampiran</th>
						<th class="text-center bold">Tgl MCU</th>
					</tr>
				</thead>
			</table>
		</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
    	table = $('#tableMedical').DataTable( {
    		"processing" : true,
			"serverSide" : true,
			"order": [],
			"ajax" : {
				"url"  : '<?php echo site_url('dtMedical')?>',
				"type" : "POST",
		   //  	"data" : function ( data ) {
