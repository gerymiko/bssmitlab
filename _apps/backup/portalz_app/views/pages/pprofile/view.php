	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Ganti Password <button type="button" class="close" data-dismiss="modal">&times;</button></h4>
			</div>
...
<div class="modal" id="modal-edit-data">
	<div class="modal-dialog modal70">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Ubah Data <button type="button" class="close" data-dismiss="modal">&times;</button></h4>
			</div>
			...
			if($("#form-edit-password").valid() == false){
				...
				function(data) {
					if(data == "Success"){
						...
						swal({title: "",html: '<i class="fas fa-check-circle f40 margin10 text-green"></i><br>Password was successfully changed. You must logout first.',type: "",confirmButtonText: 'Okay', allowOutsideClick: false }).then(function() { window.location.href = 'https://web.binasaranasukses.com/mosento/m/logivalja'; });
					} else if(data == "same") {
						$("#loading").addClass("hidden");
						swal({title: "",html: '<i class="fas fa-exclamation-circle f40 margin10 text-red"></i><br>Use a different password from the old one.',type: "",confirmButtonText: 'Okay',});
					} else if(data == "notsecure") {
						$("#loading").addClass("hidden");
						swal({title: "",html: '<i class="fas fa-exclamation-circle f40 margin10 text-red"></i><br>Use combination number and alphabet PLEASE!.',type: "",confirmButtonText: 'Okay',});
					} else {
						$("#loading").addClass("hidden");
						$('#modal-edit-password').modal('toggle');
