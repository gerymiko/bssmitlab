<section class="content-header" id="header-content">
	<h1>
		<div class="btn-group">
			...
			<button type="button" class="btn bg-navy btn-xs">A</button>
	    </div>
		<span class="label no-padding text-black">Master Kemampuan</span>
		<button type="button" data-tooltip="Tambah Kemampuan" data-tooltip-location="left" class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#modal-add-skill" data-backdrop="static" data-keyboard="false">
...
<section class="content" id="main-content">
	<div class="box">
		<div class="box-body">
			<table id="table_skill" class="table table-border table-striped table-hover" width="100%">
				<thead>
					<tr>
						<th>No</th>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#recruit, #master-treeview, #master-skill").addClass("active");
		var table = $('#table_skill').DataTable({
			"processing": true,
			"serverSide": true,
			"stateSave": true,
			"order": [],
			...
			"responsive": true,
			"ajax": {
				"url": '<?=site_url()?>web/table/master_skill',
				"type": 'POST',
				// data : function(data){
	   ...
	   //          },
			...
			"columns": [
				...
				{ "data": "skill", "className": "text-left", "searchable": false, "orderable": false },
	...
	function removeThis(id, name){
	    swal({
	        title: "",
	        html: '<i class="fas fa-question-circle f40 margin10 text-red"></i><br>Non-Aktifkan kemampuan ini? <br>(<b>'+name+'</b>).',
	        type: "",
