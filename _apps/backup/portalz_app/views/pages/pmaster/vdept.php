<section class="content-header" id="header-content">
	<h1>
		<div class="btn-group">
			...
			<button type="button" class="btn bg-navy btn-xs">E</button>
	    </div>
		<span class="label no-padding text-black">Master Departemen</span>
		<button type="button" data-tooltip="Tambah Departemen" data-tooltip-location="left" class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#modal-add-dept" data-backdrop="static" data-keyboard="false">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#recruit, #master-treeview, #master-dept").addClass("active");
	   ...
	   //          },
			...
			"columns": [
				...
				{ "data": "cert", "className": "text-left", "searchable": false, "orderable": false },
