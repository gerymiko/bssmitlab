<section class="content-header" id="header-content">
	<h1>
	    ...
	    <span class="label no-padding text-black">Pelamar <b>Gagal Web</b></span>
	</h1>
</section>
...
<section class="content" id="main-content">
	...
	<div class="box">
		<div class="box-body">
			<table id="table_failed" class="table table-border table-striped table-hover" width="100%">
				<thead>
					<tr>
						<th>No</th>
						<th>Nama</th>
