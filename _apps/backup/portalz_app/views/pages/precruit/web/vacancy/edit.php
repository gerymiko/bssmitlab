            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" name="tgl_open" class="form-control datepicker _CnUmB required" placeholder="Contoh : <?=date('d-m-Y')?>" maxlength="10" value="<?=date('d-m-Y', strtotime($dvacan->tgl_open))?>">
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
                     <label class="control-label">Tanggal Buka</label>
                     <input type="text" name="tgl_close" class="form-control datepicker _CnUmB required" placeholder="Contoh : <?=date('d-m-Y', strtotime('+1 month'))?>" maxlength="10" value="<?=date('d-m-Y', strtotime($dvacan->tgl_close))?>">
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
                     <label class="control-label">Terendah</label>
                     <input type="text" name="min_salary" id="rupiah1" class="form-control _CnUmB" maxlength="10" placeholder="Contoh : 1.000.000" value="<?=$dvacan->min_salary?>">
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
                     <label class="control-label">Tertinggi</label>
                     <input type="text" name="max_salary" id="rupiah2" class="form-control _CnUmB" maxlength="10" placeholder="Contoh : 8.000.000" value="<?=$dvacan->max_salary?>">
                  </div>
               </div>
            </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input type="text" name="jml_rekrut" class="form-control _CnUmB required" placeholder="Contoh : 10" maxlength="3" value="<?=$dvacan->jml_rekrut?>" >
                        </div>
                     </div>
                  </div>
   ...
   $(document).ready(function(){
      ...
      $("#btn_edit_vacancy").click(function(){
         ...
         if($("#form_edit_vacancy").valid() == false){
            ...
            $.post("<?=base_url();?>web/edit/vacancy",
            formdata,
            function(data){
               if(data == "Success"){
                  $("#loading").addClass("hidden");
