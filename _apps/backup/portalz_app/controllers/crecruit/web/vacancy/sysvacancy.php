    ...
    class Sysvacancy extends CI_Controller {
        ...
        public function index(){
            $data = array(
                ...
                'css_script' => array(
                    '<link rel="stylesheet" type="text/css" href="'.site_url().'../bssmitlab/_assets/global/bs-wysihtml5/bs-wysihtml5.min.css"/>',
                ...
                'js_script' => array(
                    '<script type="text/javascript" src="'.site_url().'../bssmitlab/_assets/global/bs-wysihtml5/bs-wysihtml5.all.min.js"></script>',
        ...
        public function table_vacancy(){
            ...
            foreach ($vacancy as $field){
                if ($field->lowongan_status == 1) {
                    $status = '<span class="text-green">BUKA</span>';
                    $btn = "";
                } else {
                    $status = '<span class="text-red">TUTUP</span>';
                    $btn = "hidden";
                }
                $start++;
                $row         = array();
                ...
                $row['action'] = '
                            ...
                            <a class="btn bg-gray btn-xs" data-tooltip="Ubah" onClick="btn_edit_vacancy(\''.$this->my_encryption->encode($field->lowongan_id).'\', \''.$field->KodeJB.'\')">
