<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class Mod_register extends CI_Model {
		...
		var $column_search = array('a.people_reg_date'); 
	    ...
	    private function _get_datatables_query(){
			...
			$this->db->group_by('a.people_id, a.people_fullname, a.people_email, a.people_gender, c.city_name, a.people_mobile, a.people_reg_date, a.people_birth_date, a.people_phone');
