...
<body class="hold-transition login-page bg-navy">
    <div class="login-box">
        <div class="login-logo">
            <img src="<?=site_url();?>s_url/logo" alt="BSS PORTAL" class="logo" width="200">
        </div>
        <div class="login-box-body">
            <p class="login-box-msg"><i>Silahkan login</i></p>
            <div id="notify"></div>
            <form id="form-login" action="#" method="post">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control required" name="nik" id="nik" value="1007425" placeholder="NIK / Username" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="10">
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <input type="password" class="form-control required" name="password" id="password" placeholder="Password" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="25" value="55555">
                ...
                <br>
                <small><p class="text-center">Akses dari browser <b>smartphone</b> dan <b>desktop</b> anda kapanpun dan dimanapun!</p></small>
            </form>
        </div><br>
