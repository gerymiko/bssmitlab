<section class="content-header" id="header-content">
   	<h1>Pelamar <b>MCU</b><small>Manual</small></h1>
   	<ol class="breadcrumb">
      	<li><a href="#">Rekrutmen</a></li>
      	<li><a href="#">Manual</a></li>
      	<li class="active">Pelamar MCU</li>
   	</ol>
</section>
...
<section class="content" id="main-content">
	<div class="row mobile">
		<div class="col-md-12">
			<div class="btn-group pull-right">
				...
				<button class="btn bg-red"><i class="fas fa-filter"></i></button>
			</div>
		</div>
	</div>
	...
	<div class="box">
		<div class="box-body slide-content">
			<table id="table_applicant_medical" class="table table-bordered table-hover" style="width:100%">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var table = $('#table_applicant_medical').DataTable({
			...
			"ajax": {
				"url": '<?=site_url()?>recman/table/medical/applicant',
				"type": 'POST',
				"data" : function(data){
	...
	$("#btn_sv_mcu").click(function (){
		...
		if($("#form_decision_mcu").valid() == false){
			...
			$.post("<?=base_url();?>recman/medical/add/result",
			formdata,
			function(data){
				if(data == "Success"){
					$("#loading").addClass("hidden");
