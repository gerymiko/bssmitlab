<section class="content">
	<div class="row">
		<div class="col-md-12">
			<ul class="timeline">
				<li class="time-label">
					<span class="bg-purple">Detail Interview</span>
				</li>
				<li>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">Keterangan (Lulus / Tidak Lulus)</label>
								<input type="text" name="conclusion_ket" id="conclusion_ket" class="form-control _CalPhaNum required" maxlength="100" placeholder="Ketik disini">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label">Referensi</label>
								<textarea class="form-control _CalPhaNum required" name="reference" id="reference" row="2" maxlength="100" placeholder="Ketik disini"></textarea>
							</div>
						</div>
					</div>
					<small>*Perubahan terhadap data ini akan masuk dalam <b>log aplikasi</b>.</small>
	...
	$(document).ready(function(){
		...
		$("#btn_sv_melamar").click(function (){
			...
			if($("#form_edit_melamar").valid() == false){
				...
				$.post("<?=base_url();?>recman/interview/change/app_info",
				formdata,
				function(data){
					if(data == "Success"){
						$("#loading").addClass("hidden");
		...
		$('#modal-edit-blacklist').on('show.bs.modal', function (event) {
			if (event.namespace == 'bs.modal') {
				...
				var modal     = $(this)
				modal.find('#id').val(id)
				modal.find('#conclusion_ket').val(descript)
		...
		$("#btn_sv_blacklist").click(function (){
			...
			if($("#form_edit_blacklist").valid() == false){
				...
				$.post("<?=base_url();?>recman/interview/change/stage/blacklist",
				formdata,
				function(data){
					if(data == "Success"){
						$("#loading").addClass("hidden");
		...
		$('#modal-edit-berkas').on('show.bs.modal', function (event) {
			if (event.namespace == 'bs.modal') {
				...
				modal.find('#statusinterview').val(conclusion).trigger('change')
			}
		});
		$("#btn_sv_berkas").click(function (){
			...
			if($("#form_edit_berkas").valid() == false){
				...
				$.post("<?=base_url();?>recman/interview/change/stage/app_file",
				formdata,
				function(data){
					if(data == "Success"){
						$("#loading").addClass("hidden");
		...
		$("#btn_sv_hrdteknis").click(function (){
			...
			if($("#form_edit_hrdteknis").valid() == false){
				...
				$.post("<?=base_url();?>recman/interview/change/stage/technical",
				formdata,
				function(data){
					if(data == "Success"){
						$("#loading").addClass("hidden");
		...
		$("#btn_sv_teori").click(function (){
			...
			if($("#form_edit_teori").valid() == false){
				...
				$.post("<?=base_url();?>recman/interview/change/stage/theory",
				formdata,
				function(data){
					if(data == "Success"){
						$("#loading").addClass("hidden");
		...
		$("#btn_sv_praktek").click(function (){
			...
			if($("#form_edit_praktek").valid() == false){
				...
				$.post("<?=base_url();?>recman/interview/change/stage/practice",
				formdata,
				function(data){
					if(data == "Success"){
						$("#loading").addClass("hidden");
		...
		$("#btn_sv_mcu").click(function (){
			...
			if($("#form_edit_mcu").valid() == false){
				...
				$.post("<?=base_url();?>recman/interview/change/stage/medical",
				formdata,
				function(data){
					if(data == "Success"){
						$("#loading").addClass("hidden");
