<section class="content">
	<div class="box box-primary">
		...
		<form role="form" id="form_interview" method="post" action="#">
			<input type="hidden" name="people_id" value="<?=$detail->people_id?>">
			...
			<div class="box-body">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<div class="input-group date">
								...
								<select name="interview_site" id="interview_site" class="form-control select2 pull-right required">
					                <option></option>
					                <?php
				...
				<div id="content-step" class="box box-custom">
					...
					<div class="box-body">
						<?php
							if ($dinterview !== false) {
								$berkas    = ($dinterview->berkas == 1 && $dinterview->interview_status == 1) ? "disabled" : "";
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<div class="checkbox">
			                            <label><input type="checkbox" <?=$berkas?>  class="checkcus" name="test_type[]" id="test_file" value="1">Berkas <em></em></label>
			                        </div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<div class="checkbox">
			                            <label><input type="checkbox" <?=$hrdteknis?> class="checkcus" name="test_type[]" id="test_hrd" value="2">Interview HRD &amp; Teknis</label>
			                        </div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<div class="checkbox">
			                            <label><input type="checkbox" <?=$teori?> class="checkcus" name="test_type[]" id="test_theory" value="3">Tes Teori</label>
			                        </div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<div class="checkbox">
			                            <label><input type="checkbox" <?=$praktek?> class="checkcus" name="test_type[]" id="test_practice" value="4">Tes Praktek</label>
			                        </div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<textarea name="conclusion_ket" id="conclusion_ket" class="form-control required" row="3" maxlength="100" placeholder="Ketik disini"></textarea>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="control-label">Referensi</label>
									<textarea class="form-control required" name="reference" id="reference" row="3" maxlength="100" placeholder="Ketik disini"></textarea>
								</div>
							</div>
						</div>
					</div>
	...
	$(document).ready(function(){
		...
		$('#form_interview').validate({
		    rules: { 
		    	...
		    	'election_file': { required: true },
		    },
		    messages: {
				'test_type[]': { required: "Select one of the selection stages", },
				'election_file': { required: "Select the answer for the question above" }
			}		    
		});
		...
		$("#btn_sv_interview").click(function (){
			...
			if($("#form_interview").valid() == false){
				...
				$.post("<?=base_url();?>'recman/interview/add",
				formdata,
				function(data) {
					if(data == "Success"){
						$("#loading").addClass("hidden");
