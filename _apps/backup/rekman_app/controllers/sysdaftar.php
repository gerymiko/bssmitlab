<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Sysdaftar extends CI_Controller {
        ...
        function save_registrasi() {
            ...
            $json_people['people_data'] = json_encode($dataPersonal);
            $people_id = $this->mod_karir_daftar->insert_json_in_db($json_people['people_data']);
           ...
           //          'people_id'               => $people_id, 
           //          'freshgraduate'           => 1, 
           //          'completed_data_reg'      => 1, 
           //          'completed_sertifikat'    => 0, 
           //          'completed_photo'         => 0, 
           //          'completed_skill'         => 0, 
           //          'completed_berkas'        => 0, 
           //          'completed_pasangan'      => 0, 
           //          'completed_anak'          => 0, 
           //          'completed_answer'        => 0, 
           //          'completed_berkas_kk'     => 0, 
           //          'completed_berkas_ijazah' => 0
           //      );
