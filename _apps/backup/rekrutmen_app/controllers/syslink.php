<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Syslink extends CI_Controller {
        ...
        public function banner_login(){
            $lokasi      = dirname("E:\\").'/images/karir/login/';
        ...
        public function slider_1(){
            $lokasi      = dirname("E:\\").'/images/karir/slider/';
        ...
        public function parallax_1(){
            $lokasi      = dirname("E:\\").'/images/karir/header/';
        ...
        public function parallax_404(){
            $lokasi      = dirname("E:\\").'/images/karir/header/';
            $filename    = $lokasi.'/'.urldecode('get.jpg');
            header('Content-Description: File Transfer');
            header('Content-Type: application/file');
            header('Content-Disposition: attachment; filename='.basename($filename));
            header('Content-Transfer-Encoding: binary');
