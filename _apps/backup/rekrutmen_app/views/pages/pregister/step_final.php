...
<section id="content">
	<div class="container clearfix">
		...
		<form action="#" method="post" role="form" id="form-final" class="nobottommargin">
		    <section id="content">
				<div class="clearfix">
	        ...
	        <section id="content">
				<div class="clearfix">
					<div class="col_full nobottommargin">
						<a href="<?=site_url('sysdaftar/step_6')?>" class="button button-small button-rounded button-reveal button-border tleft nomargin"><i class="icon-line-arrow-left"></i><span>Sebelumnya</span></a>
	    ...
	    if ($('#form-final').valid() === false) {
			...
			swal({
			  ...
			  showLoaderOnConfirm: true,
				...
				if (isConfirm.value) {
					$.ajax({
						url: "<?=site_url()?>registration/save_registrasi",
						type: "post",
						success:function(data){
							if (data == "Success") {
								...
								swal({
						            ...
						            window.location = "https://web.binasaranasukses.com/karir/login";
						        });
						    } else {
						    	$('#loading').addClass('hidden');
