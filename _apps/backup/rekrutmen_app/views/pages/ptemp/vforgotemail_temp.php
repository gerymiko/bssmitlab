														            ...
														            <td style="color:#333333;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:18px" align="left">
														                ...
														                <table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%" align="left">
														                    <tbody>
														                        ...
														                        <tr>
														                            <td>Sistem kami menerima notifikasi untuk perubahan password akun Anda di website kami <a target="_blank" href="https://web.binasaranasukses.com"><b>PT BINA SARANA SUKSES</b></a>.</td>
														                        </tr>
														                        <tr>
														                            <td>
														                                <table width="1" border="0" cellspacing="0" cellpadding="1" >
														                        ...
														                        <tr>
														                            <td><b>Tautan Konfirmasi :</b></td>
														                        </tr>
														                        <tr>
														                            <td>Klik tautan ini untuk menyetujui perubahan password Anda. <a href="https://web.binasaranasukses.com/karir/for/p/validate/<?=$passcrypt;?>">Klik disini</a></td>
														                        </tr>
														                        <tr>
														                            <td>
														                                <table width="1" border="0" cellspacing="0" cellpadding="1" >
														                        ...
														                        <tr>
														                            <td>Untuk <b>MENOLAK</b> perubahan password, abaikan email ini.</td>
														                        </tr>
														                        <tr>
														            ...
														            <td style="color:#333333;font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:18px" align="left">
														                ...
														                <table border="0" cellspacing="0" cellpadding="0" style="font-family:Helvetica,Arial,sans-serif" width="100%" align="left">
														                    <tbody>
														                        ...
														                        <tr>
														                            <td><?=date("l").", ".date("d-m-Y")." ".date("g:i:s A");?></td>
														                        </tr>
														                        <tr>
														                            <td>Browser:</td>
														                        </tr>
