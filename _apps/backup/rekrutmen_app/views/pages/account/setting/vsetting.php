						...
						<div class="col-md-6">
							<form id="form-new-password" method="post" action="#" role="form" class="nobottommargin">
								<div class="form-group">
									<label class="col-form-label uppercase">Password Lama <b class="red">*</b></label>
								...
								<div class="form-group" >
									<label class="bold uppercase">Password Baru <b class="red">*</b></label>
								...
								<div class="form-group" >
									<label class="bold uppercase">Ketik Ulang Password <b class="red">*</b></label>
									<div class="input-group">     
...
<script type="text/javascript">
	...
	$('#form-new-password').validate({
	    ...
	    messages: {
	        password_old: "Masukkan password lama anda.",
	        password: "Masukkan password baru.",
	        repassword: "Password baru tidak cocok.",
	    }
	});
	...
	function save_new_password(){
		...
		if($("#form-new-password").valid() == false){
			...
			$.post("<?=base_url();?>account/snew_password",
			datapass,
			function(data){
				if(data == "Success"){
					$("#notif_success").show();
					...
					swal("Oops!", "Gagal diproses. Reload lalu coba lagi", "error");
				}
			});	
		}
	}
