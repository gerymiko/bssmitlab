...
<section class="content">
   ...
   <div class="row">
      <div class="col-md-12">
         <div class="box">
            <div class="box-header with-border bg-gray">
               <img src="<?=site_url();?>s_url/icon_dozer" alt="Dozer" width="60" >
               <h3 class="box-title text-bold desktop"> DOZER</h3>
               <div class="box-tools">
                  <div class="input-group input-group-sm" style="width: 150px;">
                     <input type="text" name="dozer_search" id="dozer_search" class="form-control _CalPhaNum pull-right" placeholder="Search">
                     <div class="input-group-btn">
                        <button class="btn btn-default"><i class="fa fa-search"></i></button>
                     </div>
                  </div>
                  <div style="padding: 5px;"></div>
                  <h3 class="box-title text-bold mobile"> DOZER</h3>
               </div>
            </div>
      ...
      <div class="col-md-12">
         <div class="box">
            <div class="box-header with-border bg-gray">
               <img src="<?=site_url();?>s_url/icon_exca" alt="Excavator" width="60" >
      ...
      <div class="col-md-12">
         <div class="box">
            <div class="box-header with-border bg-gray">
               <img src="<?=site_url();?>s_url/icon_hd" alt="Heavy Dump Truck" width="60">
...
<script type="text/javascript">
   $(document).ready(function () {
      ...
      } else { $('#modal-edit-password').modal('hide'); }
      ...
      var tableDozer = $('#table_unit_dozer').DataTable({
         ...
         "ajax": {
            "url"  : '<?=site_url()?>dashboard/t_dozer',
            "type" : 'POST',
            error: function(data){
               swal({
                  animation: false,
      ...
      $('#dozer_search').keyup(function(){ tableDozer.search($(this).val()).draw(); });
      ...
      var tableHD = $('#table_unit_hd').DataTable({
         ...
         "columns": [
            ...
            { "data": "site", "className": "text-center", "orderable": false },
            { "data": "lastupdate", "className": "text-left", "orderable": false },
            { "data": "status", "className": "text-center", "orderable": false },
         ],
         "drawCallback": function ( settings ) {
            var api = this.api(), rows = api.rows( { page:'current' } ).nodes(), last = null;
