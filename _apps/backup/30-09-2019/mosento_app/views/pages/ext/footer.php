...
<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/portal/js/datatables/buttons/dataTables.buttons.min.js"></script>
<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/portal/js/datatables/buttons/buttons.html5.min.js"></script>
<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/portal/js/datatables/jszip/jszip.min.js"></script>
