<h4 style="margin-top: 0px;"><span class="label label-danger">PELAMAR</span> Interview KSPM & HRD - <small>Data keseluruhan pelamar yang menjalani proses interview KSPM & HRD.</small></h4>
<hr>
<div class="panel panel-primary panel-table">
								...
								<div class="panel-body" style="padding: 7px;">
									<div class="col-sm-3">
										<div class="form-group" style="padding: 2px">
											<select class="form-control input-sm" id="interview_hrd" name="interview_hrd">
	...
	<div class="panel-body">	
		<div style="white-space: nowrap; height: auto; overflow-x: scroll; overflow-y: hidden; cursor: pointer;">
			<table class="table table-responsive table-bordered white-bg" id="tableMonitorHrd">
				<thead>
					<tr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
    	tbHRD = $('#tableMonitorHrd').DataTable( {
    		"processing" : true,
			"serverSide" : true,
			"stateSave": true,
			"order": [],
			"ajax" : {
				"url"  : '<?php echo site_url('dtMonitorHrd')?>',
				"type" : "POST",
	            error: function(data) {
					swal("Oh Noez!", "Gagal menarik data! Coba lagi", "error");
				},
				"data" : function ( data ) {
					data.interview_hrd = $('#interview_hrd').val();
	...
	function gagalseleksihrd(pelamar_id){
	    swal({
	        title: "Konfirmasi",
	        text: "Apakah pelamar ini tidak lolos seleksi interview KSPM & HRD ?",
	        type: "warning",
		...
		function() {
			$.ajax({
				url: "<?php echo site_url()?>gagalseleksihrd/",
				type: "post",
				data: {pelamar_id:pelamar_id},
				success:function(){
					swal("Naiss!", "Pelamar telah digagalkan.", "success");
					tbHRD.ajax.reload();
				},
				error:function(){
