    ...
    class Syslogin extends CI_Controller {
        ...
        function __construct() {
            ...
            if ($this->session->userdata('users_id') != null && $this->session->userdata('tipeapp') != 'WEB_PORTAL') {
                redirect('https://web.binasaranasukses.com/portal/syslogin');
            }
        ...
        function index(){
            $data = array(
                'sheader' => 'pages/ext/sheaderlog',
                'sfooter' => 'pages/ext/sfooterlog',
            );
            $this->load->view('pages/public/public_login', $data);
        }
