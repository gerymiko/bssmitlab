<div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
   	<div class="mdl-card mdl-shadow--2dp">
	   	<div class="mdl-card__title">
	   		<h5 class="mdl-card__title-text">User &amp; Access Management</h5>
	   	</div>
		<div class="mdl-card__supporting-text no-padding">
			<table id="table_user" class="table table-bordered" width="100%" style="border: 2px solid #ddd;">
      	...
      	<div class="mdl-card__menu">
		    <?php
		        if ($accessRights->id_level == 1) {
		           echo '
		               <button class="pull-right mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-teal" data-toggle="modal" data-target="#modal-add-user-module" id="tt7">
		                  <i class="material-icons">add</i>
		               </button>
		               <div class="mdl-tooltip mdl-tooltip--left" data-mdl-for="tt7">
		                  Add User Module
		               </div>
		               <button class="pull-right mdl-button mdl-js-button mdl-button--icon mdl-button--raised mdl-js-ripple-effect button--colored-orange" data-toggle="modal" data-target="#modal-add-user" id="tt6" style="margin-right:5px;">
		                  <i class="material-icons f14">person_add</i>
		               </button>
...
<div class="modal" tabindex="-1" role="dialog" id="#modal-edit-user-module" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<form id="form-module" method="post" action="#">
				...
				<div class="modal-footer">
					...
					<button type="button" id="btn_module" class="btn bg-yellow">Save</button>
				</div>
			</form>
		</div>
	</div>
</div>
<div class="modal" tabindex="-1" role="dialog" id="modal-add-user-module" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<form id="form-add-moduser" method="post" action="#">
				...
				<div class="modal-footer">
					<button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
					<button type="button" id="btn_add_moduser" class="btn btn-primary">Save</button>
				</div>
			</form>
		</div>
	</div>
</div>
<div class="modal" tabindex="-1" role="dialog" id="modal-add-user" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<form id="form-add-user" method="post" action="#">
				...
				<div class="modal-footer">
					<button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
					<button type="button" id="btn_add_user" class="btn btn-primary">Save</button>
				</div>
			</form>
		</div>
	</div>
</div>
<div class="modal" tabindex="-1" role="dialog" id="modal-edit-user" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<form id="form-edit-user" method="post" action="#">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<span>* Leave it <b>BLANK</b> if you don't want to change password.</span>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
				...
				<div class="modal-footer">
					<button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
					<button type="button" id="btn_edit_user" class="btn btn-primary">Save</button>
				</div>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	$(document).ready(function (){
    	...
    	$('#treeview-master, #link_master_user').addClass('mdl-navigation__link--current');
