<div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone">
    <div class="mdl-card mdl-shadow--2dp">
        <div class="mdl-card__title">
            <h5 class="mdl-card__title-text">Resume Physical Results - Obj</h5>
        </div>
        <div class="mdl-card__supporting-text no-padding">
        	...
        	<div class="dragscroll">
	            <table id="table_resume_physical_results" class="table table-bordered" width="100%" height="100%" style="border: 3px solid #ddd;">
					<thead>
						<tr>
...
<script type="text/javascript">
    $(document).ready(function (){
    	$('#link_resume_physical_results').addClass('mdl-navigation__link--current');
    	var table = $('#table_resume_physical_results').DataTable({
    		"processing": true,
    		"serverSide": true,
    		"select": true,
         	"bLengthChange": false,
    		...
    		"order": [],
    		"ajax": {
    			"url": '<?=site_url('table/resume_physical_results/').$accessRights->site?>',
    			"type": 'POST',
    			data : function(data) { data.tahun = $("#tahun").val(); },
    		...
    		"columns": [
	    		...
	    		{ "data": "link_input_obj_kpi", "className": "text-left" },
