	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/portalweb/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="<?=siteURL()?>bssmitlab/_assets/portalweb/dist/js/bss.min.js"></script>
