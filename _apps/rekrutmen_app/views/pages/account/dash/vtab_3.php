					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select class="form-control js-select2 required" name="edu_place" id="edu_place">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="edu_tahun_lulus" maxlength="10" class="numdate datepicker form-control input-sm required" value="<?=date("d-m-Y", strtotime($dedufor->edu_tahun_lulus));?>" />
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="informaledu_dari" class="numdate datepicker form-control input-sm required" autocomplete="off" id="informaledu_dari" />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>Sampai <b class="red">*</b></label>
								<input type="text" name="informaledu_sampai" class="numdate datepicker form-control input-sm required" autocomplete="off" id="informaledu_sampai" />
							</div>	
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function save_edit_eduformal(){
		...
		if($("#form-edit-eduformal").valid() == false){
			...
			$.post("<?=base_url();?>save_edit_eduformal",
			paramstr,
			function(data) {
				if(data == "Success"){
	...
	function save_add_informal(){
		...
		if($("#form-add-informal").valid() == false){
			...
			$.post("<?=base_url();?>save_add_informal",
			paramstr,
			function(data) {
				if(data){
	...
	function save_edit_informal(){
		...
		if($("#form-edit-informal").valid() == false){
			...
			$.post("<?=base_url();?>save_edit_informal",
			paramstr,
			function(data) {
				if(data == "Success"){
	...
	function delete_informal(informaledu_id){
	    ...
	    swal({
			...
			if (result.value) {
			    $.ajax({
					url: "<?=site_url()?>account/cdashboard/syseducation/delete_informal",
					type: "post",
