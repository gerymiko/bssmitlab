	...
	<div class="slider-parallax-inner">
		<div class="swiper-container swiper-parent">
			<div class="swiper-wrapper">
				<div class="swiper-slide dark" style="background-image: url('<?=site_url();?>s_url/slider_1');">
				...
				<div class="swiper-slide" style="background-image: url('<?=site_url();?>s_url/slider_2'); background-position: center top;">
					<div class="container clearfix">
						<div class="slider-caption">
							<h2 data-caption-animate="fadeInUp" class="white">Profesional <br/>&amp; Sinergi</h2>
							<p data-caption-animate="fadeInUp" data-caption-delay="200" class="dark">Mengkolaborasikan Profesionalisme dengan Sinergi yang efektif untuk menjawab segala tantangan usaha.</p>
						</div>
					</div>
				</div>
			</div>
...
<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?=site_url();?>s_url/parallax_1'); padding: 120px 0;" data-stellar-background-ratio="0.3">
	<div class="container clearfix">
...
<?php 
	if ($this->session->userdata('username') == NULL){
		echo '
			<a href="'.site_url().'sysloker" class="button button-full button-light center tright nomarginbottom">
				<div class="container clearfix">
		...
		echo '
			<a href="'.site_url().'account/cloker/sysvacancy" class="button button-full button-light center tright nomarginbottom">
				<div class="container clearfix">
					Cek lowongan yang tersedia sekarang juga. <strong data-animate="bounceInRight">Cari Sekarang</strong> <i class="icon-caret-right" style="top:4px;"></i>
				</div>
			</a>
