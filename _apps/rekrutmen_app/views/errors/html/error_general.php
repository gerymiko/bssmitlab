...
<html lang="en">
	<head>
		...
		<?php
			$page_title = $heading;
			include VIEWPATH.'pages'.DIRECTORY_SEPARATOR.'ext'.DIRECTORY_SEPARATOR.'exhead.php';
		?>
	</head>
	...
	<body class="stretched">
		...
		<?php
			include VIEWPATH.'pages'.DIRECTORY_SEPARATOR.'ext'.DIRECTORY_SEPARATOR.'exfoot.php';
		?>
