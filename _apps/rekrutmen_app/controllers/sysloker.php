<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Sysloker extends CI_Controller {
        ...
        public function table_loker(){
            ...
            foreach ($loker as $field) {
                ...
                $tw      = "https://twitter.com/share?source=sharethiscom&text=".$title."&url=".$url."&via=web.binasaranasukses.com";
                $in      = "https://www.linkedin.com/shareArticle?mini=true&url=".$url."&title=".$title."&summary=".$summary."&source=BerbagiYuks.com";
                $mail    = "https://www.linkedin.com/shareArticle?mini=true&url=".$url."&title=".$title."&summary=".$summary."&source=BerbagiYuks.com";
                ...
                $row[]  = '
                    <div style="padding: 0;">
                        <tr>
                            <td>
                                <a target="_blank" href="'.site_url('vacancy/detail/'.$id.'/'.strtolower($subtitle)).'">
